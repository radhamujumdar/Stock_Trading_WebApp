...
class Trial extends React.Component{
  ...
  render(){
    ...
    return (
      ...
      {
        this.state.temp_arr.map((d) => <tr id="symbhover" onClick={() => this.fetchStock(d.symbol)}><td style={{width:"90px"}}>{d.symbol}</td><td style={{width:"240px"}}>{d.comp_name}</td>
      <td class="leftal" style={{width:"135px"}}>{d.price}</td><td class="leftal" style={{width:"145px"}}>{d.change_p}</td><td style={{width:"90px"}}><button class="btn2 leftal"><i class="fa fa-minus"></i></button></td></tr>)
      }
